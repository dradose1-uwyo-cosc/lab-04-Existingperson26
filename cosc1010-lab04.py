...
# Lab 03 
# Lab Section: 12
# Sources, people worked with, help given to: Chauncy Hendon, Cole Jordan
# your
# comments
# here
...
minAvg = minSum / size
maxAvg = maxSum / size
print(f"The average minimum temp is {minAvg}")
print(f"The average maximum temp is {maxAvg}")
